...
\begin{document}
	...
	\section{Geometría}
		...
		\subsection{Polígonos}
			...
			\inputminted[tabsize=2,breaklines,firstline=197,lastline=224,fontsize=\small]{c++}{geometry.cpp}
			
			\subsubsection{Cortar un polígono con una recta}
			\inputminted[tabsize=2,breaklines,firstline=226,lastline=257,fontsize=\small]{c++}{geometry.cpp}
