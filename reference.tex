...
\begin{document}
	...
	\section{Flujos}
		...
		\inputminted[tabsize=2,breaklines,firstline=23,lastline=46,fontsize=\small]{c++}{flow.cpp}
		
		\subsection{Algoritmo de Edmonds-Karp $O(VE^2)$}
		\inputminted[tabsize=2,breaklines,firstline=90,lastline=115,fontsize=\small]{c++}{flow.cpp}
		
		\subsection{Algoritmo de Dinic $O(V^2E)$}
		\inputminted[tabsize=2,breaklines,firstline=48,lastline=88,fontsize=\small]{c++}{flow.cpp}
