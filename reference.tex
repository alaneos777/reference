...
\begin{document}
	...
	\section{Estructuras de datos}
		...
		\inputminted[tabsize=2,breaklines,firstline=792,lastline=825,fontsize=\small]{c++}{queries.cpp}
		...
		\inputminted[tabsize=2,breaklines,firstline=692,lastline=725,fontsize=\small]{c++}{queries.cpp}
		
		\subsection{Wavelet Tree}
		\inputminted[tabsize=2,breaklines,firstline=727,lastline=790,fontsize=\small]{c++}{queries.cpp}
