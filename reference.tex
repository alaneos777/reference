...
\begin{document}
	...
	\section{Teoría de números}
		...
		\subsection{Cribas}
			...
			\inputminted[tabsize=2,breaklines,firstline=898,lastline=930,fontsize=\small]{c++}{numberTheory.cpp}
			
			\subsubsection{Criba de primos lineal}
			\inputminted[tabsize=2,breaklines,firstline=849,lastline=863,fontsize=\small]{c++}{numberTheory.cpp}
			
			\subsubsection{Criba lineal para funciones multiplicativas}
			\inputminted[tabsize=2,breaklines,firstline=865,lastline=896,fontsize=\small]{c++}{numberTheory.cpp}
	...
	\section{FFT}
		...
		\subsection{FFT módulo $n$ arbitrario}
