...
\begin{document}
	...
	\section{Estructuras de datos}
		...
		\subsection{AVL Tree}
		\inputminted[tabsize=2,breaklines,firstline=211,lastline=422,fontsize=\small]{c++}{queries.cpp}
		
		\subsection{Treap}
		\inputminted[tabsize=2,breaklines,firstline=424,lastline=517,fontsize=\small]{c++}{queries.cpp}
